...
<h2><a class='w3-button w3-white w3-border w3-border-black w3-round-large' href="kurtizinute.php" class="tema">Prideti žinute nuo administracijos</a></h2>
...
?>
    <tr>
      <td><?php PRINT $row['zinute']?></td>
       <td> 
       <?php PRINT "<a class='w3-button w3-white w3-border w3-border-red w3-round-large' href='zinutesdelete.php?ID=" . $row['ID'] . "' >Ištrinti</a>"?>
       </td>
    </tr>
