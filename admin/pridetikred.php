...
$dbname = "forumas";
  ...
  die("Connection failed: " . $conn->connect_error);
   ...
   $vardas = $_GET['vardas'];
   $kreditai = (int)$_GET['kreditai'];
   $ID = $_GET['ID'];



   $sql="UPDATE vartotojai SET kreditai = kreditai + ".$kreditai." WHERE username= '".$vardas."'";
if ($conn->query($sql) === TRUE) {
  echo "";
} else {
  echo "" . $conn->error;
}
$sql2="UPDATE saskaitos SET statusas = 'Sumokėta ir kreditai pridėti' WHERE ID='".$ID."'";
