...
?>
    <tr>
      <td><?php PRINT $row['komentaras']?></td>
      <td><?php PRINT $row['vartotojas']?></td>
      <td><?php PRINT $row['data']?></td>
       <td> 
       <?php PRINT "<a class='w3-button w3-white w3-border w3-border-red w3-round-large' href='komentarodelete.php?ID=" . $row['ID'] . "' >Ištrinti</a>"?>
       </td>
    </tr>
