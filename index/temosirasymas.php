...
if ($kiekis == 0 && $kiekis2 == 0)
{
  ?>
<div class="thing">
  <h2>Nauja tema buvo sukurta!</h2>
  <p><a href='index.php'>Atgal</a></p>
</div>

<?php
$sql="INSERT INTO temos (pavadinimas, aprasymas , kurejas, vartotojas)
VALUES ('" . $_POST["pavadinimas"] . "', '" . $_POST["aprasymas"] . "', '" . $vartotojas . "',(SELECT ID FROM vartotojai WHERE username='".$vartotojas."'))";
...
?>
<div class="thing">
  <h2>Nauja tema nebuvo sukurta nes yra blogų žodžių</h2>
  <p><a href='index.php'>Atgal</a></p>
</div>
