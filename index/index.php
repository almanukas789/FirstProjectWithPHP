...
<?php
  ...
  $sql = "SELECT * FROM temos WHERE paryskintas='0'ORDER BY ID DESC";
...
?>
  <div class="temos">
    ...
    if ($_SESSION['username'] == $row['kurejas'] || $_SESSION['role'] == '2')
      {
      ?>
      <h4 class="delete">
...
<?php
  ...
  <div class="card">
  <form action="ieskojimas.php" method="GET">
  <input class="ieskoti" type="text" name="ieskoti" placeholder="Ieskoti...">
</form>
    </div>
    <div class="card">
